...
module.exports = {
  ...
  // 打包输出文件夹
  outputDir: `assets/${projectName}`,
  productionSourceMap: false,
  pages: {
    index: {
      entry: 'src/main.ts',
      template: 'public/mpptx.html',
      filename: 'mpptx.html'
    }
  },
  pluginOptions: {
...
##### <font color="#08c">windi.config.ts</font>
配置 windicss 原子类样式库使用

```ts
import { defineConfig } from 'windicss/helpers'
import plugin from 'windicss/plugin'
import { windPreset } from 'can-can-need-bug'
